...
const extraData = [
  {
    title: "จัดส่งฟรี",
    description: "จัดส่งฟรีเมื่อซื้อครบ ฿1000",
    icon: <Truck size={45} />,
  },
  {
    title: "คืนสินค้าฟรี",
    description: "คืนสินค้าฟรีเมื่อซื้อครบ ฿1500",
    icon: <GitCompareArrows size={45} />,
  },
  {
    title: "ฝ่ายบริการลูกค้า",
    description: "ฝ่ายบริการลูกค้าที่เป็นมิตรตลอด 24 ชั่วโมง",
    icon: <Headset size={45} />,
  },
  {
    title: "รับประกันคืนเงิน",
    description: "ได้รับการตรวจสอบคุณภาพโดยทีมงาน",
