...
const data: ContactItemData[] = [
  {
    title: "Visit Me",
    subtitle: "King Mongkut's University of Technology North Bangkok 1518 Pracharat 1 Road,Wongsawang, Bangsue, Bangkok 10800 Thailand.",
    icon: (
  ...
  {
    title: "Working Hours",
    subtitle: "Mon - Fri : 10:00 AM - 4:00 PM",
    icon: (
  ...
  {
    title: "Email",
    subtitle: "rattachat.jenjob@gmail.com",
    icon: (
