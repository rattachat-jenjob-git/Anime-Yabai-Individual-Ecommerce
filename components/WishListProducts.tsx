...
const WishListProducts = () => {
  ...
  const handleResetWishlist = () => {
    const confirmReset = window.confirm(
      "คุณแน่ใจว่าต้องการรีเซ็ตรายการสินค้าที่อยากได้ของคุณใช่ไหม?"
    );
    if (confirmReset) {
      resetFavorite();
      toast.success("รีเซ็ตรายการสินค้าที่อยากได้สำเร็จแล้ว");
    }
  };
        ...
        <div className="flex min-h-[400px] flex-col items-center justify-center space-y-6 px-4 text-center">
          ...
          <div className="space-y-2">
            <h2 className="text-2xl font-semibold tracking-tight">
              ไม่มีรายการสินค้าที่อยากได้
            </h2>
            <p className="text-sm text-muted-foreground">
              รายการที่เพิ่มในรายการสินค้าที่อยากได้ของคุณจะแสดงที่นี่
            </p>
          </div>
          <Button asChild>
            <Link href="/shop">ช้อปปิ้งต่อเลย !!!</Link>
          </Button>
        </div>
      )}
    </Container>
