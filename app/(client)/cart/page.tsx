...
const CartPage = () => {
  ...
  const handleResetCart = () => {
    const confirmed = window.confirm(
      "คุณแน่ใจว่าต้องการรีเซ็ตตะกร้าสินค้าของคุณใช่ไหม?"
    );
    if (confirmed) {
      resetCart();
      toast.success("รีเซ็ตตะกร้าสำเร็จแล้ว!");
    }
  };
                  ...
                  <div className="lg:col-span-1">
                    <div className="hidden md:inline-block w-full bg-white p-6 rounded-lg border">
                      ...
                      <div className="space-y-4">
                        ...
                        >
                          {loading ? "โปรดรอสักครู่..." : "ดำเนินการชำระเงิน"}
                        </Button>
                      </div>
                    </div>
                    {addresses && (
                      <div className="bg-white rounded-md mt-5">
                        <Card>
                          <CardHeader>
                            <CardTitle>ที่อยู่การจัดส่ง</CardTitle>
                          </CardHeader>
                          <CardContent>
                            <RadioGroup
